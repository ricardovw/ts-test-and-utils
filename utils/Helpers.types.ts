import { TestType, Expect, ToEqual, ToBe, ToNotBe } from '../utils/Test.types'
/*
UUID
---
...
type _TestUuidValid_ = TestType<Expect<'806a76bf-b43d-4567-9ef9-b06c042ce461', ToBe<Uuid>>>
type _TestUuidInvalid_ = TestType<Expect<'806a76bf-4567-9ef9-b06c042ce461', ToNotBe<Uuid>>>
type _TestUuidInvalidTwo_ = TestType<Expect<'test-uuid-invalid', ToNotBe<Uuid>>>
/*
OBJ KEYS
---
...
type _TestUnionFromObj_ = TestType<Expect<UnionFromObj<{ id: number, user: string }>, ToEqual<'id' | 'user'>>>
/*
OBJ FROM UNION
---
...
type _TestObjFromUnion_ = TestType<Expect<ObjFromUnion<'id' | 'user'>, ToEqual<{ id: unknown, user: unknown}>>>
type _TestObjFromUnionWithValue_ = TestType<Expect<ObjFromUnion<'id' | 'user', 'test'>, ToEqual<{ id: 'test', user: 'test'}>>>
/*
FILTER
---
